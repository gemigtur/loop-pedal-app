...
export const CountdownOverlay: React.FC<CountdownOverlayProps> = ({
  ...
  const [currentCount, setCurrentCount] = React.useState(4);
  ...
  useEffect(() => {
    if (isVisible) {
      ...
      // Set up the countdown interval synced to BPM
      beatIntervalRef.current = setInterval(() => {
        ...
        if (count > 0) {
          ...
          // Countdown complete - dramatic exit
    ...
    <Animated.View style={[styles.overlay, { opacity: opacityAnim }]}>
      <Animated.View style={[styles.content, { transform: [{ scale: scaleAnim }] }]}>
        ...
        <View style={styles.textContainer}>
          ...
          <Text style={styles.instructionText}>Recording will start after countdown</Text>
